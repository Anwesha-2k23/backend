...
class register(View):
    ...
    def post(self, request):
        ...
        new_sponsor = Sponsors.objects.create(sponsor_email = sponsor_email , sponsor_name = sponsor_name , sponsor_facebook_id = sponsor_facebook_id , sponsor_instagram_id = sponsor_instagram_id , sponsor_phone_number = sponsor_phone_number , sponsor_link = sponsor_link, sponsor_linkdin_id = sponsor_linkdin_id)
        new_sponsor.save()
